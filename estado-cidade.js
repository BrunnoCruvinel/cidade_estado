...
function estado_cidade(idEstado,idCidade){
  ...
  estado.addEventListener('change', function(){
    ...
    cidade.innerHTML = ""
    var uf = this.selectedIndex

    for (var i = 0; i < estados[uf].cidades.length; i++) {
      var option = document.createElement("option")
      option.value = estados[uf].cidades[i]
      option.text = estados[uf].cidades[i]
      cidade.add(option)
    }
